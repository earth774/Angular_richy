...
export class UserComponent implements OnInit {
  ...
  province: any;
  search_amphur;
  constructor(private fb:FormBuilder,private userService:UserService,private _sanitizer: DomSanitizer) { 
...
onSelectChange(e){
  ...
  list(name,status,location){
    this.userService.getUser(name,status,location).subscribe(heroes => {this.heroes = heroes;
 ...
 readThis(): void {
        ...
        var img1 = this.img1.nativeElement;
